                ...
                <div class="bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <div class="flex justify-between items-center mb-6">
                            <h2 class="text-2xl font-bold">Create New Sale</h2>
                        ...
                        <form id="saleForm" action="{{ route('sales.store') }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                ...
                                <div class="col-span-2 md:col-span-1">
                                    ...
                                    <input type="datetime-local" name="date" id="date" value="{{ old('date', now()->format('Y-m-d\TH:i')) }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
                                </div>
                              ...
                              <!-- Payment Status Field ke baad ye add karein -->
                                ...
                                <div class="col-span-2">
                                    ...
                                    <textarea name="notes" id="notes" rows="2" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">{{ old('notes') }}</textarea>
                                </div>
                            </div>
